...
from src.config.settings import SCORE_COLORS, EDUCATION_COLORS
...
def render_score_distribution(df):
    ...
    fig.update_layout(
        title={"text": "Candidate Score Distribution", "x": 0.0},
...
def render_education_score_chart(df):
    ...
    fig.update_layout(
        title={"text": "Average Candidate Score by Education Level", "x": 0.0},
