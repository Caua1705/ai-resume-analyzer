...
class CandidateAnalysis(BaseModel):
    """
    Structured output generated by the LLM after analyzing a candidate resume
    against a specific job description.

    This schema defines the format of the AI evaluation used in the system.
    It ensures that the language model returns standardized data that can be
    safely validated and stored in the database.
